...
public class JobOrder_Parts  implements GTranDet{
    ...
    ArrayList<Model_JobOrder_Parts> paDetail;
    ArrayList<Model_JobOrder_Parts> paRemDetail;
    
    public JobOrder_Parts(GRider foAppDrver){
        poGRider = foAppDrver;
    }
    ...
    public Model_JobOrder_Parts getJOParts(int fnIndex){
    ...
    public JSONObject addDetail(String fsTransNo){
        ...
        if (paDetail.size()<=0){
            paDetail.add(new Model_JobOrder_Parts(poGRider));
            ...
            poJSON.put("message", "JO Parts add record.");
        } else {
            paDetail.add(new Model_JobOrder_Parts(poGRider));
...
//                    } 
    ...
    public void setDetailList(ArrayList<Model_JobOrder_Parts> foObj){this.paDetail = foObj;}
    ...
    @Override
    public Model_JobOrder_Parts getDetailModel(int fnRow) {
    ...
    private JSONObject RemoveDetail(Integer fnRow){
        ...
        if (paRemDetail.size()<=0){
            paRemDetail.add(new Model_JobOrder_Parts(poGRider));
